...
static const char *fifth[] = {    
    ...
    "    args[j] = 0;",  
    "    char oneself[256];",
    "    snprintf(oneself, sizeof(oneself), \"ONESELF=\\\'%s\\\'\\n\", argv[0]);",
    "    if (write(file[1], oneself, strlen(oneself)) < 0) {",
    ...
    "       close(file[0]);",
    "       write_script(file[1]);", 
    "       snprintf(oneself, sizeof(oneself), \"\\n}\\nbc6ed3178a784d9cb8411fd1297a6b1e \\\"$@\\\"\");",
    "       if (write(file[1], oneself, strlen(oneself)) < 0) {",
    "           perror(\"Failed to write to pipe\");",
    "           return 1;",
    "       }",
...
int main(int argc, char **argv)
{
    ...
    char *shellc = "bc6ed3178a784d9cb8411fd1297a6b1e";
    char *operators = "+-*/%&|^";
